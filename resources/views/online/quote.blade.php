...
<body>
 ...
 <div class="container-fluid">
     @include('online.partials.mainHeader')
 </div>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <hr>
          <a class="btn btn-light" href="{{url('quotes/'.$quote->id.'/download')}}">download</a>
          <a class="btn btn-light" href="{{url('quotes/'.$quote->id.'/print')}}">print</a>
            </div>
            <div class="col-12">
