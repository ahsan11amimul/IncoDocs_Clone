    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 border">
                <p>Seller</p>
                <?php $item=App\Contact::where('id',$purchase->buyer_id)->first();?>
            ...
            <div class="col-6">
               <div class="row">
                   <div class="col-6 border">
                       ...
                       <p>{{$purchase->dispatch_id?App\Dispatch::where('id',$purchase->dispatch_id)->first()->value('name'):''}}</p>

                   </div>
                   <div class="col-6 border">
                       <p>Type of Shipment</p>
                       <p>{{$purchase->shipment_type}}</p>
                   </div>
               </div>
               <div class="row">
                   <div class="col-6 border">
                       <p>Port of Loading</p>
                       <p>{{$purchase->loading_id?App\Place::where('id',$purchase->loading_id)->first()->value('name'):''}}</p>
                   </div>
                   <div class="col-6 border">
                        <p>Port of Discharge</p>
                        <p>{{$purchase->discharge_id?App\Place::where('id',$purchase->discharge_id)->first()->value('name'):''}}</p>
                   </div>
               </div>
            </div>
            <div class="col-6 border-right">
                <div class="row">
                    <div class="col-12">
                         ...
                         <p>{{$purchase->payment_method?App\Detail::where('id',$purchase->payment_method)->first()->value('description'):''}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-6 border">
                <p>Additional Information</p>
                 <p>{{$purchase->additional_info?App\Detail::where('id',$purchase->additional_info)->first()->value('description'):''}}</p>
            ...
            <div class="col-6 border">
                <div class="row border-bottom">
                    ...
                    <div class="col-4">
                       <p class="text-center">{{$purchase->discount}}</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                       <p class="text-center">{{$purchase->invoice_total}}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-6 border">
                <p>Bank Details</p>
                <p>{{$purchase->bank_detail?App\Detail::where('id',$purchase->bank_detail)->first()->value('description'):''}}</p>
            ...
            <div class="col-6">
                <div class="row border-bottom border-right">
                    ...
                    <div class="col-6">
                        <p class="text-right">{{$purchase->action_date}}</p>
                    </div>
                </div>
                <div class="row border-right border-bottom">
                    <div class="col-12">
                        <p>Signature Company</p>
                        <p>{{$purchase->signatory_company}}</p>
                    </div>
                </div>
                <div class="row border-right border-bottom">
                    <div class="col-12">
                    ...
                    <div class="col-6">
                    <p>{{$purchase->first_name}}</p>
                    </div>
                    <div class="col-6">
                     <p>{{$purchase->last_name}}</p>
                    </div>
                </div>
                <div class="row border-right border-bottom">
                    <div class="col-12">
