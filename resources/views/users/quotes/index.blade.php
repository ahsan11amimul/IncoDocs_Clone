...
<div class="container">
 <div class="row">
         ...
         @endif
          ...
          <a class="btn btn-primary text-white"  href="quotes/create"><i class="fas fa-plus mr-2"></i>
            Create New
          </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
            ...
            <input type="hidden" name="quote_number" id="quote_number">
             ...
             <div class="form-group row">
              ...
              <div class="col-sm-10">
              <p class="col-sm-10 form-control">Quote <span id="number"></span> for <span id="total"></span> need approval.</p>
        ...
        <div>
          <p>Hi,</p>
          <p>Here is Quote <span id="number1"></span> for <span id="total1"></span> is awaiting your approval. </p>
          <p>View your quote online: [Online Quote Link]</p>
