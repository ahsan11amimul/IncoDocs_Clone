            ...
            <div class="card mt-5">
                ...
                <form method="POST" action="{{route('company')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="registration_number" type="registration_number" class="form-control @error('registration_number') is-invalid @enderror" name="registration_number" value="{{ old('registration_number') }}" required autocomplete="registration_number">
