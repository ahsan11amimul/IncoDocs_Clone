<div id="commercial" class="modal fade" role="dialog">
 <div class="modal-dialog  modal-xl">
  <div class="modal-content">
   <div class="modal-header"> 
     <h4 class="modal-title">Commercial Invoice</h4>
       ...
       <form id="sample_form" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
                <div class="col-6 border">
                    <div class="form-row">
                        <div class="form-group col-12">
                            <label for="seller" class="col-form-label">Exporter</label>
            ...
            <div class="row">
                <div class="col-6 border">
                    <div class="form-group col-12">
                        <label for="seller" class="col-form-label">Consignee</label>
                        <select name="seller" id="seller" class="form-control">
                            <option value="">Select...</option>
                            <option value="1">Option 1</option>
                        </select>
                ...
                <div class="col-6 border">
                    <div class="form-group col-12">
                        <label for="seller" class="col-form-label">Buyer(if not Consignee)</label>
                        <select name="seller" id="seller" class="form-control">
                            <option value="">Select...</option>
                            <option value="1">Option 1</option>
                        </select>
                ...
                <div class="col-6 border">
                    ...
                    <div class="form-row border">
                        <div class="form-group col-6">
                            ...
                            <select name="discharge_port" id="discharge_port" class="form-control">
                                <option value="">-</option>
                                <option value="1">Option 1</option>
                            </select>
                        </div>
