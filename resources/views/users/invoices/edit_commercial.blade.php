                ...
                <div class="row">
                            ...
                            <div class="col-6 border">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="reference" id="reference" class="form-control" value="{{$invoice->reference}}" />
                                    </div>
                                    <div class="col-6 form-group">
                                        <label for="buyer_reference" class="col-form-label">Buyer Reference</label>
                                    <input type="text" name="buyer_reference" id="buyer_reference" class="form-control" value="{{$invoice->buyer_reference}}" />
                                    </div>
                                </div>
                            </div>
                </div>
                    ...
                    <div class="col-6 border">
                        <div class="form-group col-12">
                            ...
                            <select name="consignee_id" id="consignee_id" class="form-control">
                                <option value="{{$invoice->consignee??''}}">{{$invoice->consignee?App\Contact::where('id',$invoice->consignee)->first()->value('first_name'):'Select'}}</option>
                                 @foreach (App\Contact::where('user_id',Auth::user()->id)->get() as $item)
								<option value="{{$item->id}}">{{$item->first_name}}</option>
								 @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-6 border">
                        ...
                        <div class="form-row border">
                            <div class="form-group col-6">
                                ...
                                <input type="text" name="vessel" class="form-control" id="vessel" value="{{$invoice->vessel}}">
                            </div>
                            <div class="form-group col-6">
                                <label for="voyage_no" class="col-form-label">Voyage No</label>
                                <input type="text" name="voyage_no" class="form-control" id="voyage_no" value="{{$invoice->voyage_no}}">
                            </div>
                        ...
                        <div class="form-row border">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="date" name="departure_date" id="departure_date" class="form-control" value="{{$invoice->departure_date}}">
                            </div>
                        </div>
                        <div class="form-row border">
                            <div class="form-group col-6">
                            ...
                            <input type="text" name="destination" class="form-control" id="destination" value="{{$invoice->destination}}">
                            </div>
                    ...
                    <div class="col-6 border">
                        <div class="form-row border">
                            <div class="form-group col-6">
                                ...
                                <select name="origin" id="origin" class="form-control">
                                   ...
                                   <option value="{{$invoice->origin??''}}">{{$invoice->origin?App\Place::where('id',$invoice->origin)->first()->value('name'):'-'}}</option>
                            ...
                            <div class="form-group col-6">
                                ...
                                <select name="final_destination" id="final_destination" class="form-control">
                                   <option value="{{$invoice->final_destination??''}}">{{$invoice->final_destination?App\Place::where('id',$invoice->final_destination)->first()->value('name'):'-'}}</option>
                                    @foreach (App\Country::all() as $item)
								   <option value="{{$item->id}}">{{$item->name}}</option>
									@endforeach
                                </select>
                        ...
                        <div class="form-row border">
                            <div class="form-group col-md-12">
                                ...
                                <select name="payment_method" id="payment_method" class="form-control">
                                   	 <option value="{{$invoice->payment_method??''}}">{{$invoice->payment_method?App\Detail::where('id',$invoice->payment_method)->first()->value('name'):'Details'}}</option>
                        ...
                        <div class="form-row border">
                            ...
                            <input type="text" class="form-control" name="marine" id="marine" value="{{$invoice->marine}}">
                            </div>
                            <div class="form-group col-6">
                                <label for="credit" class="col-form-label">Letter Of Credit No</label>
                                <input type="text" class="form-control" name="credit" id="credit" value="{{$invoice->credit}}">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 border">
                        <div class="form-group row">
                            ...
                            <input type="text" name="discount" id="discount"class="col-sm-8 form-control discount" value="{{$invoice->discount}}" />
                        </div>
                        <div class="form-group row">
                            <label for="invoice_total" class="col-sm-4 col-form-label">Invoice Total</label>
                            <input type="text" name="invoice_total" id="invoice_total" class="col-sm-8 form-control"  value="{{$invoice->invoice_total}}" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-6 border">
                        <div class="form-row">
                            ...
                            placeholder="place of issue" value="{{$invoice->place}}" />
                            </div>
                            <div class="form-group col-md-4">
                            <input type="date" name="action_date" id="action_date" class="form-control" value="{{$invoice->action_date}}" />
                            </div>
                            <div class="form-group col-md-12">
                                <label for="signatory_company" class="col-form-label">Signatory Company</label>
                            <input type="text" name="signatory_company" name="signatory_company" class="form-control" value="{{$invoice->signatory_company}}" />
                            </div>
                            <div class="col-md-12">
                            ...
                            class="form-control" value="{{$invoice->first_name}}" />
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" name="last_name" id="last_name" placeholder="Last Name"
                                    class="form-control" value="{{$invoice->last_name}}" />
                            </div>
                            <div class="col-md-12">
...
<script>
	$(document).ready(function(){
        ...
        var count = 1;
        $('#code'+count).blur(function(){
			console.log($('#code'+count).val());
            alert($('#code'+count).val());
